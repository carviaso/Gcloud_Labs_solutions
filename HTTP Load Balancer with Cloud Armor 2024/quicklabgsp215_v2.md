# HTTP Load Balancer with Cloud Armor || 2024 || GSP215
...
curl -LO raw.githubusercontent.com/gcpsolution99/GCP-solution/main/HTTP%20Load%20Balancer%20with%20Cloud%20Armor/GSP215.sh
sudo chmod +x GSP215.sh
./GSP215.sh
```

Copy como 'quicklabgsp215_v2.sh'
```bash
# Variables
export INSTANCE_NAME=$REGION1-mig
export INSTANCE_NAME_2=$REGION2-mig
export INSTANCE_NAME_3=$REGION3-mig
...
check_status() {
    if [ $? -eq 0 ]; then
        ...
        echo "❌ Error: Failed to create the firewall rule $RULE_NAME."
        exit 1
    fi
}
...
# Creacion de Template de Intancias $REGION1-template
echo 'Creacion de Template de Intancias $REGION1-template'
...
# Creacion de Template de Intancias $REGION2-template
echo 'Creacion de Template de Intancias $REGION2-template'
...
# Creacion de Template de Intancias grupos $REGION1-mig
echo 'Creacion de Template de Intancias grupo $REGION1-mig'
...
# Creacion de Intancias siege-v
echo 'Creacion de Intancias siege-v'
